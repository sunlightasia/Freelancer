...
window.PropertyTypeFacilities = Backbone.Collection.extend({
    model: PropertyTypeFacility,
    ...
    url: function () {
        return 'rest/facilities/checked/propertyType/' + this.idWrapper  + this.from + this.to + '?term=' + this.term ;
    },
