...
window.AvailablePropertyTypeFacilities = Backbone.Collection.extend({
    ...
    url: function () {
        return 'rest/propertyTypeFacilities/propertyType/' + this.idWrapper  + this.from + this.to + '?term=' + this.term ;
    },
