...
window.AvailablePropertyTypeImages = Backbone.Collection.extend({
    ...
    url: function () {
    	return 'rest/propertyTypeImages/propertyType/' + this.idWrapper + this.from + this.to + '?term=' + this.term ;
    	},
