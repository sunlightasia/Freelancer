         ...
         item.save($("#edit-form").serializeObject(), {
             success: function (model, resp) {
                 ...
                 if(item.urlRoot == 'rest/structures/' && self.model.attributes.isEnable == '1'){
                	 $.jGrowl($.i18n("System will reload to apply new structure setting after 3 seconds."), { header: this.alertOK, position: 'top-right' });
                	 setTimeout(function(){
                		 window.location.href = "/Locanda/resetstructure.action";
                	 },3000);
                 }
