...
public class LoginAction extends ActionSupport implements SessionAware {
	...
	public String execute() {
		...
		if (user != null && user.getPassword().equals(this.getPassword().trim())) {
			structures = this.getStructureService().findStructureByIdUserByStatus(user.getId(), LocandaConstants.STRUCTURE_IS_ENABLE);
			if (structures == null) {
	...
	private Integer initializeStructureForUser(Integer id_user) {
		...
		structure.setIsEnable(LocandaConstants.STRUCTURE_IS_ENABLE);
